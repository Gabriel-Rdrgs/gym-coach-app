...
import { handleDemoLogin, handleGoogleLogin } from './actions'
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 space-y-8">
        ...
        <div className="space-y-4">
          ...
          <form action={handleGoogleLogin}>
            <button
              type="submit"
              className="w-full bg-white border-2 border-gray-300 text-gray-700 p-4 rounded-xl shadow hover:shadow-lg transition-all duration-200 font-medium flex items-center justify-center gap-3"
            >

...
// Recebe o id como prop, vindo do page.tsx server-side
export default function ProgramDetailClient({ id }: { id: number }) {
  ...
  // Agora recebe o id como prop, sem precisar resolver params
  useEffect(() => {
    if (id) {
      setProgramId(id);
    }
            ...
            <div className="flex gap-4">
              <div
                className={`px-4 py-2 rounded-lg text-sm font-semibold ${
                  program.isActive ? 'text-green-400' : 'text-gray-400'
                }`}
                style={{
                    ...
                    >
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span
                          ...
                          style={{ color: getOMSStatusColor(status.status) }}
                        >
